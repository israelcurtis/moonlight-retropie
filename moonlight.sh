...
echo -e "*** MODDED BY RONFKINGSWANSON ***"
echo -e "******************************************************\n"
...
echo "moonlight stream -720 -fps 30 -audio local "$ip"" >>  moonlight720p30fps.sh
echo "#!/bin/bash" > moonlight720p60fps.sh
echo "moonlight stream -720 -fps 60 -audio local "$ip"" >>  moonlight720p60fps.sh
echo "#!/bin/bash" > moonlight1080p30fps.sh
echo "moonlight stream -1080 -30fps -audio local "$ip"" >>  moonlight1080p30fps.sh
echo "#!/bin/bash" > moonlight1080p60fps.sh
echo "moonlight stream -1080 -60fps -audio local "$ip"" >>  moonlight1080p60fps.sh
